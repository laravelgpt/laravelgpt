// Base error class for all laravelgpt errors
...
export class ApiKeyMissingError extends ProviderError {
  constructor(provider: string) {
    super(
      `API key for ${provider} is not set. Please set the ${provider.toUpperCase()}_API_KEY environment variable in your .laravelgpt.env file located in your home directory (~/.laravelgpt/.env).

For more information on setting up API keys, visit: https://github.com/cursor-ai/laravelgpt#api-keys`,
      { provider }
    );
